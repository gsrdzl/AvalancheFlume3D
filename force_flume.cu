...
void force_flume_hst (double3 *force, double3 *torque, system_par sys, particle *pp)
{
  long    nn, ii;
  char    ns;
  double  kappa, gamma, dist, ri, dvvcn_mag, dvvct_mag, comp, comp_dot, normal, aux_fric, mu, dt,
          xi, xi_dot, ff_sdt, sint, cost, tant, rect, cns_1, mass, km, gm, rho, t0, dvvct_sig, time;
...
__global__ void force_flume_dev (double3 *force, double3 *torque, system_par sys, particle *pp)
{
  long    nn, ii;
  char    ns;
  double  kappa, gamma, dist, ri, dvvcn_mag, dvvct_mag, comp, comp_dot, normal, aux_fric, mu, dt,
